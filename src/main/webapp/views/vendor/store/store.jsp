        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                    	...
                    	<c:forEach items="${storeList}" var="store">
	                        <tr >
	                            ...
	                            <td class="align-middle"><a class="btn btn-sm"
									href="<c:url value ="/vendor/store/edit?id=${store.id }"/>"><i class="fa fa-edit"></i></a></td>
	                            <td class="align-middle"><a class="btn btn-sm" href="<c:url value ="/vendor/storedetail?id=${store.id}"/>"><i
                ...
                <div class="sign-info text-center">
						<span class="text-dark d-inline-block line-height-2">You don't have store? <a href="<c:url value ="/vendor/store/add"/>">Add store</a>
						</span>
					</div>
            </div>
        </div>
