	...
	<div class="row px-xl-5">
		<div class="col-12">
			<nav class="breadcrumb bg-light mb-30">
				<a class="breadcrumb-item text-dark" href="<c:url value ="vendor"/>">Vendor</a> <a
					class="breadcrumb-item text-dark" href="<c:url value ="vendor/store"/>">Store</a> <span
	...
	<div class="row px-xl-5">
		...
		<div class="col-lg-7 h-auto mb-30">
			<div class="h-100 bg-light p-30">
				...
				<div>Created at: ${store.createAt }</div>
