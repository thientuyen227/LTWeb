		...
		<div class="col-12">
			<nav class="breadcrumb bg-light mb-30">
				<a class="breadcrumb-item text-dark" href="#">Home</a> <a
					class="breadcrumb-item text-dark" href="#">Figure</a> <span
					class="breadcrumb-item active">Figure detail</span>
			</nav>
		</div>
	</div>
</div>
				...
				<c:forEach items="${productList}" var="product">
					...
					<div class="text-center py-4">
						...
						<div class="d-flex align-items-center justify-content-center mb-1">
							<small class="fa fa-star text-primary mr-1">${product.rating }</small> 						
						</div>
					</div>
					</c:forEach>	
				</div>
