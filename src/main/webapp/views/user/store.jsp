                    ...
                    <tbody  class="align-middle">
                    	<c:forEach items="${storeList}" var="store">
	                        <tr >
	                            ...
	                            <td class="align-middle"><a class="btn btn-sm" href="<c:url value ="/home/followingstore/add?id=${store.id}"/>"><i
											class="fa fa-heart"></i></a></td>
	                            <td class="align-middle"><a class="btn btn-sm" href="<c:url value ="/home/storedetail?id=${store.id}"/>"><i
