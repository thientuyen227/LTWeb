...
<div class="container-fluid bg-dark text-secondary mt-5 pt-5">
	<div class="row px-xl-5 pt-5">
		<div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
			<h5 class="text-secondary text-uppercase mb-4">Figure Shop</h5>
			<p class="mb-4">Thông tin liên lạc</p>
			<p class="mb-2">
				<i class="fa fa-map-marker-alt text-primary mr-3"></i>Số 1 Võ Văn
				Ngân, Linh Chiểu, Tp.Thủ Đức
			</p>
			<p class="mb-2">
				<i class="fa fa-envelope text-primary mr-3"></i>Nguyenthientuyen22702@gmail.com
			</p>
			<p class="mb-0">
				<i class="fa fa-phone-alt text-primary mr-3"></i>0389546396
			</p>
		</div>
		<div class="col-lg-8 col-md-12">
			<div class="row">
				...
				<div class="col-md-4 mb-5">
					...
					<p>Đăng nhập làm thành viên để thỏa sức đam mê  <a type="submit" href="<c:url value ="/home/signin"/>">Click here!!!</a></p>
