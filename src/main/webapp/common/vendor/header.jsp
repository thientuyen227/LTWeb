...
<div class="container-fluid">
	<div class="row bg-secondary py-1 px-xl-5">
		...
		<div
			...
			<div class="col-lg-4">
				<a href="<c:url value ="/vendor"/>" class="text-decoration-none">
					<span class="h1 text-uppercase text-primary bg-dark px-2">Figure</span>
			...
			<div class="col-lg-4 col-6 text-left">
					<div class="input-group">
						...
						<input id="searchKeyWord" type="text" class="form-control"
							placeholder="Search for products" oninput="changeFormAction()">
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav mr-auto py-0">
							<a href="<c:url value ="/vendor"/>"
								...
								href="<c:url value ="/vendor/store"/>" class="nav-item nav-link">Store</a>
						</div>
