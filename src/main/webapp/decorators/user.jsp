...
<link
	...
	rel="stylesheet">
<link href="<c:url value ="/assets/vendor/aos/aos.css"/>"
	rel="stylesheet">
<link
...
<link
	...
	rel="stylesheet">
<link href="<c:url value ="/assets/vendor/remixicon/remixicon.css"/>"
	rel="stylesheet">
<link
...
<script>
	const url = "<c:url value='/home/product'/>";
	...
	function changeFormAction() {
		...
		if (document.getElementById("filterSearch")) {
			...
			showing = showing + document.getElementById("productShowing").value;
			rating = rating
					+ document
							.querySelector('input[name="filterByRating"]:checked').value;
			price = price
					+ document
							.querySelector('input[name="filterByPrice"]:checked').value;
			alert(rating)
			document.getElementById("filterSearch").action = url + showing
					+ rating + price + searchkeyword;
		} else {
			showing = showing + 9
			rating = rating + 0
			price = price + "0-300000"
			document.getElementById("searchHeader").action = url + showing
					+ rating + price + searchkeyword;
		}
	}
</script>
